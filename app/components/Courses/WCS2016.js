...
/* Import data */
import wcs2016 from '../../data/Courses/wcs2016.json';

/**
 * @class WCS2016
 * @extends {React.Component}
 */
class WCS2016 extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() { 
        let dataArr = [];
        Object.keys(wcs2016.data).forEach(function(key) {
            dataArr.push(wcs2016.data[key]);
        });
