...
/* Import data */
import cn2017 from '../../data/Courses/cn2017.json';

/**
 * @class CN2017
 * @extends {React.Component}
 */
class CN2017 extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() { 
        let dataArr = [];
        Object.keys(cn2017.data).forEach(function(key) {
            dataArr.push(cn2017.data[key]);
        });
